                            ...
                            <div class="flex items-center space-x-2">
                                <div class="relative">
                                    <select id="year-select"
                                            class="border border-gray-300 rounded-full px-6 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent w-32 pr-10 appearance-none bg-white cursor-pointer"
