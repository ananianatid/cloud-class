    ...
    <div class="w-screen h-screen flex flex-col items-center p-4 space-y-4 bg-gray-50">
        <div class="content w-full h-full flex justify-center items-center">
            <div class="flex flex-col">
                ...
                <a href="{{ route('semestre', ['semestre'=>$closestSemestre]) }}" class="bg-white box w-96 rounded-full p-4 text-gray-700 flex flex-row items-center justify-center gap-4 mb-4 hover:bg-gray-50 transition-colors duration-200">
                    Semestre {{$closestSemestre->numero}}
                </a>
                @endisset

                <a href="{{ route('emploi-du-temps-actif') }}" class="bg-white box w-96 text-blue-700 rounded-full p-4 flex flex-row items-center justify-center gap-4 mb-4 hover:bg-blue-50 transition-colors duration-200">
                    Voir l'emploi du temps actif
                </a>

                <div class="bg-white box w-96 rounded-2xl p-4 text-gray-700 flex flex-col items-center justify-center gap-4 mb-4 [&>*]:bg-white">
